...
private:
    ...
    bool        m_showEndingRunner = false;
    sf::Texture m_endingPlayerTexture;
    sf::Sprite  m_endingPlayerSprite;
    float       m_endingPlayerScale = 1.f;
    float       m_endingAnimTimer = 0.f;
    int         m_endingAnimFrame = 0;
    float       m_endingDirection = 1.f;
    float       m_endingSpeed = 240.f;
